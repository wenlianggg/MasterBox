...
<asp:Content ID="Testing" ContentPlaceHolderID="Child_Profile" runat="server">
    <div class="Setting_Profile">
        <h1>Profile</h1>
        <div class="row">
             <div class="col-xs-12 col-sm-6 col-md-8" style="border:1px solid green;">.col-xs-12 .col-sm-6 .col-md-8</div>
             <div class="col-xs-6 col-md-4" style="border:1px solid blue;">Profile Icon</div>
        </div>
